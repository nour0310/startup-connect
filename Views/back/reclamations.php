...
<head>
    <meta charset="utf-8">
    <title>startup_connect - Admin Réclamations</title>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="reponsesreclamations.html?reclamation_id=<?= $rec['id'] ?>" class="btn btn-sm btn-warning">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">startup_connect@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">startup_connect</a>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
