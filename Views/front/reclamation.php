...
<head>
    <meta charset="utf-8">
    <title>Réclamations - Startup_Connect</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="#" class="nav-item nav-link">Questions/Reponses</a>
                    <a href="Formations.php" class="nav-item nav-link">Startups</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-phone-alt me-3"></i>+216 29 999 999</p>
