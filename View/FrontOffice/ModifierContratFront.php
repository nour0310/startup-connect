  ...
  <div style="margin-bottom: 20px;" >
    ...
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        <div class="card-body">
            ...
            <option value="equity" <?= $contrat['typecontrat'] == 'Capital-investissement' ? 'selected' : '' ?>>Capital-investissement</option>
            <option value="convertible_loan" <?= $contrat['typecontrat'] == 'Prêt convertible' ? 'selected' : '' ?>>Prêt convertible</option>
            <option value="revenue_share" <?= $contrat['typecontrat'] == 'Partage de revenus' ? 'selected' : '' ?>>Partage de revenus</option>
                    </select>
                  </div>
                  <div class="form-group col-md-6"  style="margin-bottom: 10px;">
