...
<div class="container py-5" style="margin-top: 100px !important; ">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class=" text-center">
                        ...
                        <p>
                            Ce tableau présente la totalité des contrat effectué par vous.
                        </p>
                    </div>
                </div>
                <!-- /.col end-->
    ...
    <div class="row"  style="margin-bottom: 30px;">
      ...
      <div class="col-md-4">
        <button class="btn btn-secondary" style="border-radius: 30px;" type="submit">Chercher</button>
                                ...
                                <table class="table">
                                    ...
                                    <?php foreach ($contrats as $c): ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="ModifierContratFront.php?id=<?= $c['idcontrat'] ?>">
                                                 <button class="btn btn-primary" title="Modifier ce contrat">
                                                  <i class="fa fa-share-square"></i>
                                               </button>
                                            </a>
                                                 <a href="../../Controller/ContratController.php?supprimer=<?= $c['idcontrat'] ?>">
                                                  <button class="btn btn-danger" title="Supprimer ce contrat"> 
                                                    <i class="fa fa-trash"></i></button>
                                                  </a>
                                                  <?php elseif ($c['statusContrat'] === 'valider' && $c['number'] > 0): ?>
                                            ...
                                            <?php elseif ($c['statusContrat'] === 'valider' && $c['number'] == 0): ?>
                                            <a href="ajoutInvestissement.php?idcontrat=<?= $c['idcontrat'] ?>">
                                            <button class="btn btn-primary" title="Investir sur  ce contrat">
