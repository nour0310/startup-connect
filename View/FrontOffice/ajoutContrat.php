...
<div class="container py-5" style="margin-top: 100px !important; ">
  ...
  <div style="margin-bottom: 20px;" >
    <a href="startupDetail.html" >← Retour</a>
</div>
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        <div class="card-body">
            <form name="formContrat" method="post" onsubmit="return validerForm()" action="../../Controller/ContratController.php">
                ...
                <label for="inputEmail4">Utilisateur Id</label>
                <input type="text" class="form-control" name="idutilisateur">
                  </div>
                  <div class="form-group col-md-3"  style="margin-bottom: 10px;">
                  <label for="inputEmail4">Startup Id</label>
                  <input type="text" class="form-control" name="idstartup">
                  </div>
                
                 <input type="hidden" name="statusContrat">
                  ...
                  <div class="form-group col-md-6"  style="margin-bottom: 10px;">
                    ...
                    <select name="typecontrat" class="form-control">
                        ...
                        <option value="Prêt convertible">Prêt convertible</option>
                        <option value="Partage de revenus">Partage de revenus</option>
                    </select>
                    <div class="error-message" name="err-typecontrat" style="color: red;"></div>
                  </div>
                  <div class="form-group col-md-6"  style="margin-bottom: 10px;">
                    <label for="inputPassword4">Date contrat</label>
                    <input type="date" class="form-control" name="datecontrat">
                  </div>
                </div>
                <div class="form-group col-md-3"  style="margin-bottom: 10px;">
                  <label for="inputAddress">Duree contrat</label>
                  <input type="text" class="form-control" name="dureecontrat" placeholder="Duree contrat en mois">
                </div>
                <div class="form-group"  style="margin-bottom: 10px;">
                  <label for="inputAddress2">Clause sortie </label>
                  <input type="text" class="form-control" name="clauseSortie">
                </div>
                <div class="form-row">
                  <div class="form-group col-md-3"  style="margin-bottom: 10px;">
                    <label for="inputCity">Pourcentage capitale</label>
                    <input type="text" class="form-control" name="pourcentageCaptiale" >
                  </div>
                  <div class="form-group col-md-3"  style="margin-bottom: 10px;">
                    <label for="inputState">valeur Startup</label>
                    <input type="text" class="form-control" name="valeurStartup">
                  </div>
                  <div class="form-group"  style="margin-bottom: 10px;">
                    <label for="inputZip">conditions Specifiques</label>
                    <input type="text" class="form-control" name="conditionsSpecifique">
                  </div>
                  <div class="form-group"  style="margin-bottom: 10px;">
