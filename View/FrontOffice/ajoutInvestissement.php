<?php
$idcontrat = isset($_GET['idcontrat']) ? $_GET['idcontrat'] : null;
?>
...
<div class="container py-5" style="margin-top: 100px !important; ">
  <div class="col-md-6"> <h1>Ajouter Investissement</h1></div>
    ...
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <div class="form-row"  >
                ...
                <div class="form-group col-md-6"  style="margin-bottom: 10px;">
                    ...
                    <input type="text" name="contratid" class="form-control" value="<?= htmlspecialchars($idcontrat) ?>" readonly>
                  </div>
               
                <div class="form-group col-md-6"  style="margin-bottom: 10px;">
                    <label for="inputPassword4">Date Investissement</label>
                    <input type="date" class="form-control" name="date_inv">
                  </div>
                  <div class="form-group col-md-6"  style="margin-bottom: 10px;">
                ...
                <div style="margin-top: 10px;">
                  <button type="submit" class="btn btn-primary" name="ajouterInv" value="Ajouter">Ajouter </button>
