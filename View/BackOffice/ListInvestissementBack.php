                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown" style="color: white;">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="../BackOffice/ListInvestissementBack.html" class="dropdown-item">Gestion des investissements</a>
                            <a href="#" class="dropdown-item">Gestion documents</a>
                            <a href="logList.php" class="dropdown-item">Historique</a>
                        </div>
                    </div>
...
<div class="row" style="margin-bottom: 30px;">
        <div class="col-md-6"> <h1> Liste des investissements</h1></div>
...
<table class="table table-striped">
        ...
        <?php foreach ($inv as $c): ?>
          ...
          <td>
                                            ...
                                            <a href="../../Controller/InvestissementController.php?changerStatut=<?= $c['id'] ?>&statut=valider" >
                                                 <button class="btn btn-success" title="Valider ce contrat">
                                                  <i class="fa fa-check"></i>
                                               </button>
                                            </a>
                                                 <a href="../../Controller/InvestissementController.php?changerStatut=<?= $c['id'] ?>&statut=refuser" >
                                                  <button class="btn btn-danger" title="Réfuser ce contrat"> 
                                                    <i class="fa fa-times"></i></button>
                                                  </a>
                                                  <?php elseif ($c['status_inv'] === 'refuser'): ?> 
                                                    <a href="../../Controller/InvestissementController.php?supprimerBack=<?= $c['id'] ?>">
                                               
                                               <button class="btn btn-danger" title="Imprimer ce contrat">
